...
# Defining the recipe data structure
...
def add_recipe(recipes: Recipes) -> None:
    ...
    ingredients = []
    print("Enter ingredients (press 'Enter' to finish):")
    while True:
        ingredient = input("> ")
        if not ingredient:
            break
    ...
    instructions = []
    print("Enter instructions (press 'Enter'  to finish):")
    while True:
        instruction = input("> ")
        if not instruction:
            break
...
def edit_recipe(recipes: Recipes) -> None:
    ...
    print("Enter new instructions (press 'Enter'  to finish):")
    new_instructions = []
    while True:
        instruction = input("> ")
        if not instruction:
